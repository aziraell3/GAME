...
var D4SkillDB = (function(){
	...
	var gems = [
		...
		{ver:'sea1', job:'com', grade:'leg', parts:'acc', icon:'off', type:'off', name:'어두운 춤의(사악함, 공격력 - 단계 III)',  detail:'<p class="gem_effect"><span class="acc">생명력이 60% 이상인 경우, 핵심 기술이 5초마다 주 자원 대신 68~51의 생명력을 사용합니다. 생명력을 소모한 기술은 10~20% 증가한 피해를 줍니다.</span></p>'},
		{ver:'sea1', job:'com', grade:'leg', parts:'acc', icon:'off', type:'off', name:'유혹적인 운명의(사악함, 공격력 - 단계 III)',  detail:'<p class="gem_effect"><span class="acc">극대화 적중 시 40~60%의 추가 피해를 주지만, 비 극대화 적중 시 주는 피해가 20~15% 감소합니다.</span></p>'},
		...
		{ver:'sea1', job:'com', grade:'leg', parts:'acc', icon:'def', type:'def', name:'보복의(흉포함, 방어력 - 단계 III)',  detail:'<p class="gem_effect"><span class="acc">받는 피해의 10~20%가 억제됩니다. 방어, 기만, 또는 섬뜩함 기술을 사용하면 억제되었던 모든 피해가 250% 증폭되어 폭발하며 주위의 적들에게 최대 1360~2040의 화염 피해를 줍니다.</span></p>'},
		{ver:'sea1', job:'com', grade:'leg', parts:'acc', icon:'def', type:'def', name:'신중한 마음의(흉포함, 방어력 - 단계 III)',  detail:'<p class="gem_effect"><span class="acc">일격에 20% 이상의 생명력을 잃을 경우, 2.0~4.0초간 면역을 얻습니다. 이 효과는 110초에 한 번씩만 발동합니다. 결의의(간악함, 보조): 자원 고갈 효과가 40~50% 감소합니다. 추가로, 자원 생성량이 3.0~8.0% 증가합니다.</span></p>'},
		{ver:'sea1', job:'com', grade:'leg', parts:'acc', icon:'uti', type:'uti', name:'반격의(간악함, 보조 - 단계 III)',  detail:'<p class="gem_effect"><span class="acc">자신에게 걸린 군중 제어 효과가 제거될 때마다 주위 적들에게 510~680의 화염 피해를 줍니다.</span></p>'},
		{ver:'sea1', job:'com', grade:'leg', parts:'acc', icon:'uti', type:'uti', name:'치밀한 자의(간악함, 보조 - 단계 III)',  detail:'<p class="gem_effect"><span class="acc">주 자원을 150~200 소모하면 다음 공격에 적중당한 적을 2초 동안 기절시킵니다.</span></p>'},
		...
		{ver:'sea1', job:'com', grade:'leg', parts:'acc', icon:'tra', type:'tra', name:'이발사의(진노함, 초월적 - 단계 III)',  detail:'<p class="gem_effect"><span class="acc">2.0~4.0초 동안 대상이 받은 극대화 피해와 그 이후의 모든 피해를 흡수합니다. 그 후, 흡수된 피해가 한꺼번에 주위의 적들을 향해 폭발합니다. 축적된 피해는 매초 10% 증가합니다.</span></p>'},
		...
		{ver:'sea1', job:'bab', grade:'leg', parts:'acc', icon:'tra', type:'tra', name:'고통 감내의(진노함, 초월적 - 단계 IV)',  detail:'<p class="gem_effect"><span class="acc">받는 피해가 5~15% 확률로 무시되고 대신 생명력을 17~68 회복합니다.</span></p>'},
		...
		{ver:'sea1', job:'dru', grade:'leg', parts:'acc', icon:'tra', type:'tra', name:'고삐 풀린 야수의(진노함, 초월적 - 단계 IV)',  detail:'<p class="gem_effect"><span class="acc">기절, 빙결 또는 넘어뜨리기 효과에 적중당하면 40~60% 확률로 회색곰의 격노가 자동으로 3초 동안 활성화됩니다.</span></p>'},
		...
		{ver:'sea1', job:'nec', grade:'leg', parts:'acc', icon:'tra', type:'tra', name:'대향연의(진노함, 초월적 - 단계 IV)',  detail:'<p class="gem_effect"><span class="acc">각각의 하수인이 매초 정수를 1.0~2.0 고갈시키지만 50~75%의 추가 피해를 줍니다. 하수인이 없을 경우 이 추가 피해 효과가 자신에게 적용되어 매초 정수를 5씩 고갈시킵니다.</span></p>'},
		...
		{ver:'sea1', job:'rog', grade:'leg', parts:'acc', icon:'tra', type:'tra', name:'사악한 약제사의(진노함, 초월적 - 단계 IV)',  detail:'<p class="gem_effect"><span class="acc">공격 시 5~15% 확률로 모든 주입 효과를 원래 지속 효력의 40~50%로 적용합니다.</span></p>'},
		...
		{ver:'sea1', job:'soc', grade:'leg', parts:'acc', icon:'tra', type:'tra', name:'전능의(진노함, 초월적 -단계 IV)',  detail:'<p class="gem_effect"><span class="acc">투사체를 발사하는 핵심 기술이 마나를 모두 소모합니다. 추가 마나를 35~45 소모할 때마다, 추가 투사체를 하나 발사하고 피해가 3.0~5.0% 증가합니다.</span></p>'},
	];
		...
		$('#header .button-job, .button-reset').on('click', function(){
			...
			if (!$(this).is('[aria-selected=true]')) {
				if ($('[aria-controls=aspectSelect][data-target]').length > 0 || $('[aria-controls=gemSelect][data-gem-icon]').length > 0  || $('input[type=text]').val() !== '') {
					method.layerFunc('layerCommon', true, '현재 셋팅된 <strong>위상(옵션)/보석/입력값</strong>등이 있습니다.<br>확인을 누르면 셋팅된  <strong class="underline">위상(옵션)/보석/입력값</strong> 들이 초기화 됩니다. <br>그래도 초기화 하시겠습니까?', true);
