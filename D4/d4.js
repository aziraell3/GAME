...
var D4SkillDB = (function(){
	...
	var board = [
		...
		{job:'dru', name:'bbbbbbbbb', detail:'bbbbbbbbb'},
	];
	var skills = [
		...
		{job:'soc', parts:'glo', type:'uni', icon:'wep', name:'화염흉터',  detail:'<p class="unique_option"><span class="c_important">소각</span>을 사용하는 동안 주기적으로 적들에게 이끌리는 잿불을 쏘아 각각 <span class="c_random"><span class="text-line">84 - 168</span></span>의 화염 피해를 줍니다.</p>'},
		{job:'soc', parts:'glo', type:'uni', icon:'wep', name:'끝없는 분노의 지팡이',  detail:'<p class="unique_option"><span class="c_important">화염구</span>를 <span class="c_number">3</span>번 시전할 때마다 <span class="c_number">2</span>개의 추가 투사체가 발사됩니다.</p>'},
		{job:'soc', parts:'glo', type:'uni', icon:'wep', name:'람 에센의 지팡이',  detail:'<p class="unique_option"><span class="c_important">번개 줄기</span>가 적을 관통하지만 주는 피해가 <span class="c_random">40 – 30%</span> 감소합니다.</p>'},
